...
import { User, Phone, MapPin, Camera, Save, Loader2, ArrowLeft } from 'lucide-react';
...
export default function ProfileEditPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setMessage({ type: 'error', text: 'Error al guardar el perfil. Intenta de nuevo.' });
    } finally {
      setIsSaving(false);
    }
  };
    ...
    <div className="min-h-screen flex flex-col bg-white">
      ...
      <div className="flex-1 px-4 py-6">
        <div className="max-w-2xl mx-auto">
          ...
          <h1 className="text-2xl font-bold text-[#112237] mb-6">Editar mi perfil</h1>
