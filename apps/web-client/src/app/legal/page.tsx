...
export default function LegalPage() {
  const documents: Document[] = [
    {
      ...
      description:
        "Política de garantía comercial de 12 meses para productos Premium",
    ...
    },
    {
      ...
      description:
        "Condiciones generales para devoluciones y cambios de productos",
    ...
    },
    {
      ...
      description:
        "Principios de integridad, honestidad y transparencia en nuestras operaciones",
    ...
    },
    {
      ...
      description:
        "Marco de actuación para prevenir, detectar y sancionar soborno y corrupción",
    ...
    },
    {
      ...
      description:
        "Procedimientos y controles operativos para prevenir riesgos de corrupción",
    ...
    },
    {
      ...
      description:
        "Canales seguros y protección para reportar infracciones y conductas irregulares",
    ...
    },
    {
      ...
      description:
        "Documento oficial de designación del responsable de integridad corporativa",
  ...
  const integrityDocs = documents.filter(
    (doc) => doc.category === "Integridad",
  );
    ...
    <section className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 py-12 px-6">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-extrabold text-amber-600 mb-4 flex items-center justify-center gap-3">
            Centro de Documentos Legales
          </h1>
          <p className="text-lg text-gray-700 max-w-2xl mx-auto leading-relaxed">
            Accede a todas nuestras políticas, procedimientos y documentos de
            integridad corporativa. Conoce nuestro compromiso con la
            transparencia y el cumplimiento legal.
          </p>
        </div>
            ...
            {productDocs.map((doc) => (
              ...
              >
                <div className="flex items-start gap-4">
                  <span className="text-amber-600">{doc.icon}</span>
        ...
        <div className="mt-12 bg-amber-50 border-l-4 border-amber-600 rounded-lg p-6">
          ...
          <p className="text-gray-700 leading-relaxed">
            Todos los documentos de iubizon están diseñados bajo los principios
            de integridad, transparencia y cumplimiento de la ley peruana.
            Cualquier duda o consulta sobre estas políticas puede dirigirse a
            nuestra Gerencia General o a través del canal de denuncias.
          </p>
        </div>
