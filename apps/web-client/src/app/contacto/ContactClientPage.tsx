...
export default function ContactClientPage() {
  ...
  return (
    <>
      ...
      />
      <div className="h-screen min-h-screen flex flex-col lg:flex-row w-full bg-[#060e1e] relative font-sfpro">
        <div className="w-full lg:w-1/2 h-full relative group overflow-hidden">
          <Image
            ...
            priority
          />
          <div className="absolute inset-0 bg-gradient-to-t from-secondary via-secondary/80 to-primary/60 opacity-95"></div>
          <div className="absolute inset-0 flex flex-col justify-end p-8 md:p-12 text-white">
            <div className="backdrop-blur-md bg-white/5 rounded-3xl p-6 md:p-8 border border-white/20 shadow-2xl">
        ...
        <div className="w-full lg:w-1/2 flex items-center justify-center bg-gradient-to-br from-[#0a1628] to-[#060e1e] backdrop-blur-sm p-6 lg:p-8">
          <div className="w-full max-w-xl">
            <ContactForm serverActionSendContactEmail={sendContactEmail} />
          </div>
        </div>
      </div>
      <section className="py-16 bg-gradient-to-b from-[#060e1e] via-[#0a1628] to-[#060e1e]">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
            <a href="tel:+51972300301" className="group relative">
              ...
              <div className="relative bg-gradient-to-br from-white/[0.07] to-white/[0.02] p-6 rounded-3xl border border-white/10 hover:border-primary/30 transition-all duration-300 backdrop-blur-sm">
                <div className="flex flex-col items-center text-center">
                  <div className="bg-primary/20 p-4 rounded-2xl mb-4 group-hover:scale-110 transition-transform duration-300 border border-primary/20">
            ...
            >
              ...
              <div className="relative bg-gradient-to-br from-white/[0.07] to-white/[0.02] p-6 rounded-3xl border border-white/10 hover:border-primary/30 transition-all duration-300 backdrop-blur-sm">
                <div className="flex flex-col items-center text-center">
                  <div className="bg-green-500/20 p-4 rounded-2xl mb-4 group-hover:scale-110 transition-transform duration-300 border border-green-500/20">
                    <svg
            ...
            <div className="group relative">
              <div className="relative bg-gradient-to-br from-white/[0.07] to-white/[0.02] p-6 rounded-3xl border border-white/10 backdrop-blur-sm">
                <div className="flex flex-col items-center text-center">
                  ...
                  <p className="text-gray-400 text-sm mb-2">Lun - Vie</p>
                  <p className="text-white font-semibold">9:00 AM - 6:00 PM</p>
                  <p className="text-gray-400 text-sm mt-2">Sábado</p>
                  <p className="text-white font-semibold">9:00 AM - 12:00 PM</p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            <div className="bg-gradient-to-br from-white/[0.07] to-white/[0.02] p-8 rounded-3xl border border-white/10 backdrop-blur-sm">
              <div className="flex items-start mb-6">
                <div className="bg-primary/20 p-3 rounded-2xl mr-4 border border-primary/20">
              ...
              <div className="rounded-2xl overflow-hidden shadow-2xl h-64 border border-white/10">
                <iframe
            ...
            <div className="bg-gradient-to-br from-primary/20 to-secondary/20 p-8 rounded-3xl border border-primary/20 backdrop-blur-sm text-white">
