      ...
      <div className="min-h-screen flex flex-col">
        ...
        <div className="flex-1 flex items-center justify-center">
          <div className="text-center">
            <h2 className="text-2xl font-bold text-[#112237] mb-4">
              Inicia sesión para ver tus favoritos
            </h2>
            <Link
              href="/auth/login?redirect=/favorites"
              className="bg-[#f25c05] text-white px-6 py-3 rounded-lg hover:bg-[#d94d04]"
            >
              Iniciar sesión
            </Link>
          </div>
                ...
                >
                  <div className="bg-white border border-[#e2e8f0] rounded-xl p-4 hover:shadow-lg transition-shadow">
                    ...
                    <p className="text-[#f25c05] font-bold">
                      S/ {Number(fav.product?.price || 0).toFixed(2)}
                    </p>
                  </div>
                </Link>
              ))}
