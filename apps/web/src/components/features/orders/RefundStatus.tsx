    ...
    <div className="bg-white rounded-3xl border border-[#e2e8f0] p-6 shadow-sm space-y-5">
      ...
      {requests.map((req, reqIdx) => {
        ...
        return (
          <div
            key={req.id}
            className={reqIdx > 0 ? "pt-4 border-t border-[#f1f5f9]" : ""}
          >
                  ...
                  <div className="bg-[#f8fafc] rounded-2xl p-3 border border-[#e2e8f0] space-y-2.5">
                    ...
                    {!isSeller && req.status === "approved" && (
                      <div className="space-y-2">
                        <span className="text-[11px] font-semibold text-[#112237] block">
                          Registrar envío de devolución:
                        </span>
                        <input
                          type="text"
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <input
                            ...
                            onChange={(e) =>
                              setReturnEstDelivery(e.target.value)
                            }
                          />
                        </div>
                        <input
