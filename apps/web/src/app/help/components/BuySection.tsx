      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        <div className="bg-[#f8fafc] border border-[#e2e8f0] rounded-2xl p-4 space-y-2">
          ...
          <p className="text-xs text-[#64748b]">
            Selecciona productos complementarios y agréguelos a tu paquete en un
            solo pago unificado.
          </p>
        </div>
        <div className="bg-[#f8fafc] border border-[#e2e8f0] rounded-2xl p-4 space-y-2">
          ...
          <p className="text-xs text-[#64748b]">
            Genera y descarga al instante una Cotización con RUC emitida por{" "}
        ...
        <div className="bg-[#f8fafc] border border-[#e2e8f0] rounded-2xl p-4 space-y-2">
          ...
          <p className="text-xs text-[#64748b]">
            Paga mediante tarjetas de crédito o débito a través de Niubiz con
            encriptación bancaria de alta seguridad.
          </p>
        </div>
        <div className="bg-[#f8fafc] border border-[#e2e8f0] rounded-2xl p-4 space-y-2">
          <div className="w-8 h-8 rounded-xl bg-orange-100 text-[#f25c05] flex items-center justify-center font-black text-sm">
          ...
          <p className="text-xs text-[#64748b]">
            Monitorea el estado de tu pedido desde tu panel de usuario hasta
            recibirlo.
          </p>
        </div>
      </div>
