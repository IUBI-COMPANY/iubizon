...
export function RefundStatusEmail(data: RefundStatusEmailData) {
  ...
  return (
    <BaseLayout previewText={`${isApproved ? "Actualización" : "Respuesta"} de reembolso — Pedido #${data.orderCode}`}>
      ...
      <Section style={infoCardStyle}>
        ...
        <Row>
          ...
          <Column style={{ padding: "8px 12px", textAlign: "right" }}>
            ...
            <Text style={{ ...metaValueStyle, color: isApproved ? "#059669" : "#dc2626" }}>
...
const badgeStyle = (approved: boolean): React.CSSProperties => ({
  color: approved ? "#059669" : "#dc2626", fontSize: "11px", fontWeight: "800", letterSpacing: "1px", margin: "0 0 6px 0",
});
...
const amountValueStyle: React.CSSProperties = { color: "#f25c05", fontSize: "18px", fontWeight: "800", margin: "2px 0 0 0" };
const lightHrStyle: React.CSSProperties = { borderColor: "#f1f5f9", margin: "8px 0" };
const notesBoxStyle: React.CSSProperties = { backgroundColor: "#ffffff", border: "1px solid #e2e8f0", borderRadius: "12px", padding: "16px", marginTop: "20px" };
...
const notesTextStyle: React.CSSProperties = { color: "#475569", fontSize: "12px", margin: "0", lineHeight: "1.5" };
const addressBoxStyle: React.CSSProperties = { backgroundColor: "#f8fafc", borderRadius: "12px", border: "1px solid #e2e8f0", padding: "16px", marginTop: "20px" };
